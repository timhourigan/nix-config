{
  ...
  inputs = {
    ...
    # Pinning to zigbee2mqtt 2.13.0 - https://github.com/NixOS/nixpkgs/pull/548417
    nixpkgs-pinned.url = "github:nixos/nixpkgs?rev=bdb1f1c194eaa65129ecd7b1fd5cfde7c9a4a832";
