{
  ...
  inputs = {
    ...
    # Pinning to zigbee2mqtt 2.8.0 - https://github.com/NixOS/nixpkgs/pull/486039
    nixpkgs-pinned.url = "github:nixos/nixpkgs?rev=b1d0cb61d5bebcece2f9de2280c861cec0cebc5f";
