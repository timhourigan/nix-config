{
  ...
  inputs = {
    ...
    # Pinning to zigbee2mqtt 2.7.2 - https://github.com/NixOS/nixpkgs/pull/476116
    nixpkgs-pinned.url = "github:nixos/nixpkgs?rev=42b7df400e79a3b1b2ea50bede4be71442012022";
